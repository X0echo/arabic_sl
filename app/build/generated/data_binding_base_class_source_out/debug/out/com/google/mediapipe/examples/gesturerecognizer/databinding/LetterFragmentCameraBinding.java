...
import com.google.mediapipe.examples.gesturerecognizer.ArabicNavbarView;
...
public final class LetterFragmentCameraBinding implements ViewBinding {
  @NonNull
  ...
  private LetterFragmentCameraBinding(@NonNull CoordinatorLayout rootView,
  ...
  @NonNull
  public static LetterFragmentCameraBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static LetterFragmentCameraBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.letter_fragment_camera, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static LetterFragmentCameraBinding bind(@NonNull View rootView) {
    // The body of this method is generated in a way you would not otherwise write.
    // This is done to optimize the compiled bytecode for size and performance.
    int id;
    missingId: {
      id = R.id.arabicNavbarView;
      ArabicNavbarView arabicNavbarView = ViewBindings.findChildViewById(rootView, id);
      if (arabicNavbarView == null) {
        break missingId;
      }
      ...
      return new LetterFragmentCameraBinding((CoordinatorLayout) rootView, arabicNavbarView,

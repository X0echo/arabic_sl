...
public final class FragmentResultBinding implements ViewBinding {
  ...
  private FragmentResultBinding(@NonNull LinearLayout rootView, @NonNull Button retryButton,
  ...
  public static FragmentResultBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentResultBinding((LinearLayout) rootView, retryButton, scoreText);
    }

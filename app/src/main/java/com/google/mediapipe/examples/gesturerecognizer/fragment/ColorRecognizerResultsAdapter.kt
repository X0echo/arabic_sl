...
class ColorRecognizerResultsAdapter :
    RecyclerView.Adapter<ColorRecognizerResultsAdapter.ViewHolder>() {
    ...
    fun getCurrentColorAndScore(position: Int): Pair<String?, Float?> {
